...
//     document.body.classList.remove('cyber-page', 'web-page', 'data-page', 'home-page', 'flutter-page');
    
//     if (page === 'cyber.html' || page === 'blue-team.html' || page === 'red-team.html') {
...
//     } else if (page === 'flutter.html') {
//       document.body.classList.add('flutter-page');
//     } else {
